...
{
    /// <summary>
    /// Blocks UI navigation during purchase flows (e.g. overlay to prevent taps).
    /// Assign UIDocument in the inspector when possible; otherwise a fallback search runs at startup.
    /// </summary>
    public class NavigationBlocker : MonoBehaviour
    {
        ...
        {
            // Assign uiDocument in inspector when possible; FindObjectOfType is fallback at startup only.
            if (uiDocument == null)
